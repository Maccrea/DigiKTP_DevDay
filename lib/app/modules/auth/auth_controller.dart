...
class AuthController extends GetxController {
  ...
  void checkPasswordStrength(String value) {
    ...
    if (strength <= 0.25) {
      ...
      passwordHint.value =
          '⚠️ Keamanan rendah. Harap tambahkan: ${missingRequirements.join(', ')}.';
    } else if (strength <= 0.75) {
      passwordStrengthText.value = 'Sedang';
      passwordStrengthColor.value = Colors.orange;
      passwordHint.value =
          '⚠️ Hampir memenuhi standar. Kurang: ${missingRequirements.join(', ')}.';
    } else {
      passwordStrengthText.value = 'Kuat';
      passwordStrengthColor.value = Colors.green;
      passwordHint.value =
          '✔ Kata sandi telah memenuhi standar keamanan sistem.';
    }
  }
